# Deepslate Tweaks *(NeoForge repo)*
...
- **Minecraft:** 26.2 (on NeoForge 26.2 beta; see earlier releases for 26.1.x, 1.21.1, 1.21.4, 1.21.8, 1.21.11)
- **Mod loader:** NeoForge (this repo is NeoForge-only)
